...
public record UpdateProdutoDto([Required] string? CodigoProduto, [Required] string? DescricaoProduto, [Required] Guid FornecedorId, [Required] decimal PrecoUnitario, [Required] DateOnly? Validade, [Required] SituacaoProduto SituacaoProduto);