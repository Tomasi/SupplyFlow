...
public record PedidoDto(Guid Id, long Pedido, List<ItemPedidoDto>? Itens, DateOnly DataPedido, string? Fornecedor, EnumSituacao Situacao, string? Observacao, DateOnly DataAprovacao, DateOnly DataEntrega, decimal PrecoTotal);
